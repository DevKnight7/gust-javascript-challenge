...
})()(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        var _checkboxes = _interopRequireDefault(
          require("./widgets/checkboxes")
        );
    ...
    6: [
      function (require, module, exports) {
        ...
        function checkboxes(widget) {
          const controllerCB = widget.querySelector(
            "[kjs-role=controlling-checkbox]"
          );
          const relatedCBs = widget.querySelectorAll(
            "[kjs-role=related-checkbox]"
          );
